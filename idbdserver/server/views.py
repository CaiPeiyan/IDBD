            ...
            if uuid != None:
                if int(uuid) != 0:
                    ...
                    if drink:
                        ...
                        response["mobile"] = MobileSerializer(instance=drink, many=True).data
                    response['code'] = status.HTTP_200_OK
        except Exception as e:
            print(e)
            response["code"] = status.HTTP_500_INTERNAL_SERVER_ERROR
            ...
            if uuid != None:
                if int(uuid) != 0:
                    ...
                    if smoke:
                        ...
                        response["mobile"] = MobileSerializer(instance=smoke, many=True).data
                    response['code'] = status.HTTP_200_OK
        except Exception as e:
            print(e)
            response["code"] = status.HTTP_500_INTERNAL_SERVER_ERROR
            ...
            if uuid != None:
                if int(uuid) != 0:
                    ...
                    if tired:
                        ...
                        response["mobile"] = MobileSerializer(instance=tired, many=True).data
                    response['code'] = status.HTTP_200_OK
        except Exception as e:
            print(e)
            response["code"] = status.HTTP_500_INTERNAL_SERVER_ERROR
